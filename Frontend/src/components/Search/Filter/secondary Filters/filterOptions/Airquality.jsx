  ...
  return (
    ...
    <div className="w-[520px] h-[340px] bg-[#000] rounded-xl text-white font-montserrat p-6 overflow-y-auto">
      ...
      <div className="space-y-4">
        <div>
          <label htmlFor="airQualityIndex" className="block text-sm font-medium text-gray-400 mb-2">
        ...
        <div>
          <label htmlFor="pollutantConcern" className="block text-sm font-medium text-gray-400 mb-2">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2">
            {['Low Allergens', 'Low Humidity', 'Clean Indoor Air', 'Low Pollution'].map((factor) => (
        ...
        <div>
          <label className="flex items-center space-x-3 cursor-pointer">
            <input type="checkbox" className="form-checkbox h-5 w-5 text-blue-600 rounded bg-gray-700 border-transparent focus:ring-blue-500" />
            <span className="text-gray-300">Only show locations with air quality monitoring stations</span>
          </label>
        </div>
      </div>
