...
class SearchView(viewsets.ModelViewSet):
    permission_classes = [IsOwnerOrReadOnly] # to ensure that only authenticated users can access the view.
    SearchSerializer_class = SearchSerializer # to specify the serializer class that will be used to serialize the data.
